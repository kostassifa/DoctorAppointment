<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CancelBooking.aspx.cs" Inherits="DoctorAppointmentWebApp.Pages.CancelBooking" %>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                <div class="container">
                    ...
                    <!-- Add the UpdateProgress control -->
                    <asp:UpdateProgress ID="UpdateProgress1" runat="server">
                        <ProgressTemplate>
                            <div style="color: red; font-weight: bold; text-align: center; padding: 10px;">
                                Please wait, cancelling appointments,an email will be send to your account...
                            </div>
                        </ProgressTemplate>
                    </asp:UpdateProgress>
                    <div class="actions">
