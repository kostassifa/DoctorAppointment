<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MainDoctor.aspx.cs" Inherits="DoctorAppointmentWebApp.Pages.MainDoctor" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="container">
            ...
            <div class="button-grid">
                ...
                <asp:Button ID="btnCancelDoctorBooking" runat="server" Text="Cancel Booking Doctor" CssClass="action-button"  OnClick="btnCancelBookingDoctor_Click" />
                <asp:Button ID="btnViewBookingsDoctor" runat="server" Text="View Bookings Doctor" CssClass="action-button" OnClick="btnViewBookingsDoctor_Click"/>
            </div>
        </div>
